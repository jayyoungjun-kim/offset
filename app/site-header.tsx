...
export default function SiteHeader(){
  ...
  return <header className="site-header"><div className="container nav-inner">
    ...
    <nav className="nav-menu" aria-label="주요 메뉴"><Link href="/about" onClick={() => trackNavigation("about", "/about")}>About</Link><Link href="/programs" onClick={() => trackNavigation("workshop", "/programs")}><span className="workshop-menu-desktop">Programs</span><span className="workshop-menu-mobile">Programs</span></Link></nav>
  </div></header>;
}
