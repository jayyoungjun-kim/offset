...
## 푸터 구분선·px 글자 크기·상세 고정 패널

- 2026-09-08, Sites v170 배포 성공, 소스 99c74e262712f51fabb89533423abceb3f8d4b07.
- 공통 푸터 흰색+상단1px 구분선. 상세 오른쪽 신청·멘토 전체 패널 desktop sticky72px, 짧은 화면 내부 스크롤.
- HTML 도구에8~120px 글자 크기 입력/적용. 선택 범위를 유지하고 굵기·문단을 보존하며 HTML/나란히/미리보기 모두 지원. 서버 정제 범위 동기화.
- 배포된 QA1440×1000/1440×650/390×844에서 푸터·패널 위치/내부 스크롤·모바일 확인. 어드민 미리보기에서12/64/24px 적용과 구조 유지·범위 오류 검증 통과.
- 서버 저장/조회/공개 렌더 테스트20개, 타입·빌드·CI 통과: https://github.com/jayyoungjun-kim/offset/actions/runs/34188073572

## 멘토 소개 박스·웹사이트 버튼

- 2026-09-08, Sites v171, 소스 847847be5c4aa119da6ec08003a89142b34111e7 배포 성공.
- 본문 멘토 섹션을16px 라운드·얇은 테두리·화이트 박스로 정리. 본문14/22px, 제목16/24px. 원문 전체 보존.
- 두 웹사이트 링크를 하단 구분선 아래 테두리 버튼으로 전환. 경력 중 참고 링크는 인라인 유지.
- QA1440/390px에서 박스·폰트·버튼 높이/주소·가로 넘침 검사 통과. 원문 보존 포함20개 테스트/빌드/CI 성공.
- CI: https://github.com/jayyoungjun-kim/offset/actions/runs/34206674246
