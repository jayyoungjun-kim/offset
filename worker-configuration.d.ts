/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.local.json worker-configuration.d.ts` (hash: 823a2af6476119fdd50c56bdc797f609)
// Runtime types generated with workerd@1.20260515.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	GOOGLE_APPS_SCRIPT_URL: string;
	FORM_SUBMIT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_APPS_SCRIPT_URL" | "FORM_SUBMIT_SECRET">> {}
}
